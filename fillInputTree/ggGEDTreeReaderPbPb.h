...
// Sun Jul 29 22:14:15 2018 by ROOT version 5.34/36
...
#ifndef ggGEDTreeReaderPbPb_h
#define ggGEDTreeReaderPbPb_h
...
public :
   ...
   ggGEDTreeReaderPbPb(TTree *tree=0);
   virtual ~ggGEDTreeReaderPbPb();
...
#ifdef ggGEDTreeReaderPbPb_cxx
ggGEDTreeReaderPbPb::ggGEDTreeReaderPbPb(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/official/Pythia8_Z30eeJet_Hydjet_MB/HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13_ext1-FOREST/0.root:/ggHiNtuplizerGED");
...
ggGEDTreeReaderPbPb::~ggGEDTreeReaderPbPb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ggGEDTreeReaderPbPb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ggGEDTreeReaderPbPb::LoadTree(Long64_t entry)
{
...
void ggGEDTreeReaderPbPb::Init(TTree *tree)
{
...
Bool_t ggGEDTreeReaderPbPb::Notify()
{
...
void ggGEDTreeReaderPbPb::Show(Long64_t entry)
{
...
Int_t ggGEDTreeReaderPbPb::Cut(Long64_t entry)
{
...
#endif // #ifdef ggGEDTreeReaderPbPb_cxx
