...
// Mon Aug  6 12:39:52 2018 by ROOT version 6.02/13
// from TTree HltTree/
...
#ifndef hltTreeReaderPP_h
#define hltTreeReaderPP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hltTreeReaderPP(TTree *tree=0);
   virtual ~hltTreeReaderPP();
...
#ifdef hltTreeReaderPP_cxx
hltTreeReaderPP::hltTreeReaderPP(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/official/Pythia8_Z30eeJet/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3_ext1-v1-FOREST/0.root:/hltanalysis");
...
hltTreeReaderPP::~hltTreeReaderPP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hltTreeReaderPP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltTreeReaderPP::LoadTree(Long64_t entry)
{
...
void hltTreeReaderPP::Init(TTree *tree)
{
...
void hltTreeReaderPP::Show(Long64_t entry)
{
...
Int_t hltTreeReaderPP::Cut(Long64_t entry)
{
...
#endif // #ifdef hltTreeReaderPP_cxx
