...
// Mon Aug  6 12:41:21 2018 by ROOT version 6.02/13
// from TTree HltTree/
...
#ifndef globalTreeReaderPP_h
#define globalTreeReaderPP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   globalTreeReaderPP(TTree *tree=0);
   virtual ~globalTreeReaderPP();
...
#ifdef globalTreeReaderPP_cxx
globalTreeReaderPP::globalTreeReaderPP(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/official/Pythia8_Z30eeJet/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3_ext1-v1-FOREST/0.root:/skimanalysis");
...
globalTreeReaderPP::~globalTreeReaderPP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t globalTreeReaderPP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t globalTreeReaderPP::LoadTree(Long64_t entry)
{
...
void globalTreeReaderPP::Init(TTree *tree)
{
...
Bool_t globalTreeReaderPP::Notify()
{
...
void globalTreeReaderPP::Show(Long64_t entry)
{
...
Int_t globalTreeReaderPP::Cut(Long64_t entry)
{
...
#endif // #ifdef globalTreeReaderPP_cxx
