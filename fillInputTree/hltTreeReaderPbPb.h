...
// Sun Jul 29 22:10:04 2018 by ROOT version 5.34/36
// from TTree HltTree/
...
#ifndef hltTreeReaderPbPb_h
#define hltTreeReaderPbPb_h
...
public :
   ...
   hltTreeReaderPbPb(TTree *tree=0);
   virtual ~hltTreeReaderPbPb();
...
#ifdef hltTreeReaderPbPb_cxx
hltTreeReaderPbPb::hltTreeReaderPbPb(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/official/Pythia8_Z30eeJet_Hydjet_MB/HINPbPbWinter16DR-75X_mcRun2_HeavyIon_v13_ext1-FOREST/0.root:/hltanalysis");
...
hltTreeReaderPbPb::~hltTreeReaderPbPb()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t hltTreeReaderPbPb::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltTreeReaderPbPb::LoadTree(Long64_t entry)
{
...
void hltTreeReaderPbPb::Init(TTree *tree)
{
...
Bool_t hltTreeReaderPbPb::Notify()
{
...
void hltTreeReaderPbPb::Show(Long64_t entry)
{
...
Int_t hltTreeReaderPbPb::Cut(Long64_t entry)
{
...
#endif // #ifdef hltTreeReaderPbPb_cxx
