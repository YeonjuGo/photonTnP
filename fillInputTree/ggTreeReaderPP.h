...
// Mon Aug  6 12:40:40 2018 by ROOT version 6.02/13
...
#ifndef ggTreeReaderPP_h
#define ggTreeReaderPP_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ggTreeReaderPP(TTree *tree=0);
   virtual ~ggTreeReaderPP();
...
#ifdef ggTreeReaderPP_cxx
ggTreeReaderPP::ggTreeReaderPP(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/official/Pythia8_Z30eeJet/HINppWinter16DR-75X_mcRun2_asymptotic_ppAt5TeV_v3_ext1-v1-FOREST/0.root:/ggHiNtuplizerGED");
...
ggTreeReaderPP::~ggTreeReaderPP()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ggTreeReaderPP::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ggTreeReaderPP::LoadTree(Long64_t entry)
{
...
void ggTreeReaderPP::Init(TTree *tree)
{
...
void ggTreeReaderPP::Show(Long64_t entry)
{
...
Int_t ggTreeReaderPP::Cut(Long64_t entry)
{
...
#endif // #ifdef ggTreeReaderPP_cxx
