...
// Mon Aug  6 12:42:39 2018 by ROOT version 6.02/13
...
#ifndef ggTreeReaderPPData_h
#define ggTreeReaderPPData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   ggTreeReaderPPData(TTree *tree=0);
   virtual ~ggTreeReaderPPData();
...
#ifdef ggTreeReaderPPData_cxx
ggTreeReaderPPData::ggTreeReaderPPData(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TDirectory * dir = (TDirectory*)f->Get("root://xrootd.cmsaf.mit.edu//store/user/tatar/HighPtPhoton30AndZ/HIRun2015E-PromptReco-AOD-dielectron-skim-FOREST/0.root:/ggHiNtuplizerGED");
...
ggTreeReaderPPData::~ggTreeReaderPPData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ggTreeReaderPPData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ggTreeReaderPPData::LoadTree(Long64_t entry)
{
...
void ggTreeReaderPPData::Init(TTree *tree)
{
...
Bool_t ggTreeReaderPPData::Notify()
{
...
void ggTreeReaderPPData::Show(Long64_t entry)
{
...
Int_t ggTreeReaderPPData::Cut(Long64_t entry)
{
...
#endif // #ifdef ggTreeReaderPPData_cxx
